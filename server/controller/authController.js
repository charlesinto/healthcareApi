...
export const getUsers = async (req, res) => {
    try{
        const result = await executeQuery(`select a.firstname,a.lastname,a.roleid,a.rolename,b.active,b.datecreated,b.active from users a left join roles b on a.roleid = b.id`)
