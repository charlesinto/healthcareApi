...
export const getUsers = async (req, res) => {
    try{
        const result = await executeQuery(`select a.firstname,a.lastname,a.roleid,b.rolename,a.emailaddress,a.active,a.datecreated,a.active,a.phonenumber from users a left join roles b on a.roleid = b.id`)
